  ...
  public function executeList(sfWebRequest $request)
  {
    ...
    if (!$folder)
    {
      ...
      else
      {
        ...
        if ($CKEditorFuncNum = $request->getParameter('CKEditorFuncNum')) {
          $this->getUser()->setAttribute('CKEditorFuncNum', $CKEditorFuncNum, 'sf_admin/sf_asset/navigation');
        }
    ...
    $imgOnly = $request->getParameter('images_only', 0) != 0;
    $this->files = $folder->getSortedFiles($this->dirs, $this->processSort($request), $imgOnly);
